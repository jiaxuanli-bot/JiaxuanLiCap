...
export class ApiService {
  ...
  getFacultyByYear(year) {
    return this.http.get<User[]>(`${AppConstants.API_URL}/users?year=${year}`);
  }
  ...
  getCommitteesByPagation(year , pageIndex, pageLength) {
    return this.http.get<User[]>(`${AppConstants.API_URL}/users?year=${year}&pageIndex=${pageIndex}&pageLength=${pageLength}`, {} );
  }
  ...
  getUserYears(id) {
    return this.http.get<string>(`${AppConstants.API_URL}/users/${id}/years`, {} );
  }
}
